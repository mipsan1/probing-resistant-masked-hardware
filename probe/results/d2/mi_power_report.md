# Mutual Information Analysis on Power Traces — d = 2
## Setup
...
## Verdict
**FAIL** — max MI = 0.434868 bits exceeds the practical leakage threshold.
