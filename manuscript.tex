...
fixed-group imbalance and should not be interpreted as a
...
the in-house result above and PROLEAD's verdict agree on
\textit{no $d$-probing leakage}.
...
\midrule
This work (1st-order) & 1 & none ($N{=}10^4$) & secure (PROLEAD-eq.) \\
This work (2nd-order) & 2 & none ($N{=}10^4$) & secure (PROLEAD-eq.) \\
\bottomrule
\end{tabular}
\end{table}
